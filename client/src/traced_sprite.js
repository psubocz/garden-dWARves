...
var TracedSprite = exports.TracedSprite = function TracedSprite(uid, obj_id, trace, rotate) {
	TracedSprite.superConstructor.apply(this, arguments);
	this.uid = uid;
	TracedSprite._objects[this.uid] = this;
...
TracedSprite.prototype.reset_trace = function(trace) {
	this.trace = trace;
	this._lastframe = 0;
	this._totaltime = 0;
